...
mqtt_client.publish("loraham/status", "Started at {}".format(datetime.datetime.now()))
...
class LoRaRcvCont(LoRa):
    ...
    def on_rx_done(self):
        ...
        print asciimsg
        mqtt_msg = json.dumps({'station': "GI7UGV-20", 'payload': asciimsg, 'rssi': pkt_rssi, 'snr': pkt_snr})
